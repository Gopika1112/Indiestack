...
VALUES
  ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'alice@example.com', 'alice_writes', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Alice Writer', 'Loves writing about tech and indie hacking.', 'https://api.dicebear.com/7.x/avataaars/svg?seed=alice', 'https://alice.blog', 'San Francisco', true, false, 128, 42, NOW(), NOW()),
  ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', 'bob@example.com', 'bob_codes', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Bob Developer', 'Building in public, one commit at a time.', 'https://api.dicebear.com/7.x/avataaars/svg?seed=bob', 'https://bob.dev', 'New York', false, true, 89, 15, NOW(), NOW())
