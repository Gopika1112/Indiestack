    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 bg-gradient-to-b from-muted/50 to-background">
      <Card className="w-full max-w-md border-0 shadow-xl">
        <CardHeader className="text-center pb-2 pt-8">
          ...
          <h1 className="text-2xl font-bold">Join IndieStack</h1>
          <p className="text-sm text-muted-foreground mt-1">Start your writing journey today</p>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4 px-8">
            {error && (
              <div className="flex items-start gap-2 p-3 text-sm text-red-600 bg-red-50 dark:bg-red-950/20 rounded-lg">
